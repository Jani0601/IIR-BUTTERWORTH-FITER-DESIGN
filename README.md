...
## OUTPUT (LPF) : 
<img width="753" height="667" alt="image" src="https://github.com/user-attachments/assets/ee808c27-1595-48d7-9481-e42b8e417b97" />


## OUTPUT (HPF) :
<img width="944" height="830" alt="image" src="https://github.com/user-attachments/assets/e4937ba6-5400-4076-876f-fc722904f5cb" />


## RESULT: 
Thus, design of Butterworth Low pass, high pass IIR filter waveforms were plotted and output was
verified.
